 ...
 *
 */
public class ScaleAutoLeft extends Command {
    ...
    protected void initialize() {
    	Autonomous.ScaleAutoLeft(RobotMap.rd, RobotMap.liftVictor, RobotMap.intakeVictorLeft, RobotMap.intakeLifter, RobotMap.piston);
    }
