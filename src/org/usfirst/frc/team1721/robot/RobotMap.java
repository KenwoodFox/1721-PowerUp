...
public class RobotMap {
	public static final int driveMasterLeft = 0, driveMasterRight = 1, driveSlaveLeft = 1, driveSlaveRight = 0, intakeLeft = 99, intakeRight = 99, liftMaster = 2, liftSlave = 2;
	public static final int intakeButton = 1, outputButton = 3;
